...
public class EarthQuakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView distanceToPlace = (TextView) listItemView.findViewById(R.id.location_offset);
        distanceToPlace.setText(currentEarthquake.getDistanceToPlace());
     ...
     */
    private String formatDate (Date dataObj){
        SimpleDateFormat dataFormat = new SimpleDateFormat("LLL dd, yyyy");
        return dataFormat.format(dataObj);
    }
